...
function CatalogueCard({
  ...
  return (
    ...
    >
      <ImageCarousel images={project.images} alt={title} expanded={expanded} />
...
export default function ProjetsCataloguePopup({
  open,
  onClose,
}: {
  open: boolean;
    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          role="dialog"
          aria-modal="true"
          aria-labelledby="projets-catalogue-popup-title"
        ...
        >
          ...
          >
            <header className="relative shrink-0 border-b border-black/5 px-5 py-5 text-center md:px-8 md:py-6">
              ...
              <h2
                id="projets-catalogue-popup-title"
